package com.telebott.applets.bootstrap;
...
import com.telebott.applets.util.AESUtils;
import com.telebott.applets.util.ToolsUtil;
import com.telebott.applets.util.Utils;
...
//@Order(10000)
//@Component
@WebFilter(filterName = "WechatFilter", urlPatterns = {"/v1/wechat/*", })
public class WechatFilter implements Filter {
//    private static MyFilter self;
//    @Autowired
    private WechatAuthDao authDao;
//    @Autowired
    private UserDao userDao;

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        authDao = Utils.getWechatAuthDao();
        userDao = Utils.getUserDao();
